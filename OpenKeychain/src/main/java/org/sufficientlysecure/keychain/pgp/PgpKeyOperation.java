...
public class PgpKeyOperation {
    ...
    public PgpEditKeyResult createSecretKeyRing(SaveKeyringParcel saveParcel) {
        ...
        try {
            ...
            SubkeyAdd certificationKey = saveParcel.getAddSubKeys().remove(0);
    ...
    private PgpEditKeyResult internal(PGPSecretKeyRing sKR, PGPSecretKey masterSecretKey,
        ...
        try {
            ...
            { // work on master secret key
                ...
                ArrayList<WrappedUserAttribute> addUserAttributes = saveParcel.getAddUserAttribute();
                ...
                ArrayList<String> revokeUserIds = saveParcel.getRevokeUserIds();
            ...
            ArrayList<SubkeyChange> changeSubKeys = saveParcel.getChangeSubKeys();
            ...
            ArrayList<Long> revokeSubKeys = saveParcel.getRevokeSubKeys();
            ...
            ArrayList<SubkeyAdd> addSubKeys = saveParcel.getAddSubKeys();
